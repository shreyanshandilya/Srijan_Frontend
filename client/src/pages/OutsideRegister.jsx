  ...
  return (
    <div className=" p-6 rounded-lg grid grid-cols-1">
      <motion.div
        ...
        className="text-center p-2 text-[#dad3a5] font-semibold text-4xl"
      >
        Outside Signup
      </motion.div>
      <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center w-[75vw]">
        <motion.div
          initial={{ x: 20, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="cursor-pointer py-4 bg-[#544b08] w-[240px] flex justify-center focus:border-2 focues:border-[#efede0] text-[#efede0] rounded-lg px-4"

...
function Hero() {
  ...
  return (
    <>
    <motion.div variants={bgAnimate} initial="hidden" animate="show" className='max-w-screen flex justify-center items-center'>
        

<motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1}} className="w-screen bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
    <motion.div   className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <motion.h1 variants={textAnimate1} initial="hidden" animate="show" className="mb-4 text-6xl font-extrabold tracking-tight leading-none uppercase text-white md:text-5xl lg:text-6xl">srijan 2024</motion.h1>
        ...
        <motion.button variants={textAnimate2} initial="hidden" animate="show" type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><Link to='sponsor' smooth={true} spy={true} offset={100} duration={5000}>Coming Soon!</Link></motion.button>

    </motion.div>
</motion.div>

    </motion.div>
    <div className='bg-gray-900 grid grid-cols-3 gap-4 max-w-screen'>
    ...
    <motion.div className='text-8xl font-bold bg-transparent bg-clip-text opacity-70 flex justify-center items-center my-10'>Coming Soon!</motion.div>
    <div id='sponsor' className='max-w-screen p-5 md:p-10 bg-gray-800'>
      <h1 className='flex text-white font-bold text-6xl justify-center items-center'> Past Sponsors</h1>
        <div className='grid grid-cols-4 flex-wrap gap-x-5 gap-y-10 p-10 rounded-lg backdrop-blur-lg bg-opacity-60'>
            <motion.div initial={{ y: 20,x:-10 }}
            whileInView={{ x:0, y: 0 }} transition={{duration:1}} className='col-span-4 flex justify-center items-center backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
            ...
            <motion.div initial={{ x: -10 }}
            whileInView={{ x: 0 }} transition={{duration:1.1}} className='col-span-1 flex justify-center items-center bg-[url("")] backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
            ...
            whileInView={{ y: 0 }} transition={{duration:1.3}} className='col-span-1 flex justify-center items-center bg-[url("")] backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
            <img className='rounded' src="https://res.cloudinary.com/dfr1kvie3/image/upload/v1702995310/ongc_lcwi8k.png" alt="" />
            </motion.div>
            <motion.div initial={{ x: 30, y:20 }}
            whileInView={{ x: 0, y:0 }} transition={{duration:1.6}} className='col-span-1 flex justify-center items-center bg-[url("")] backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
            <img className='rounded' src="https://res.cloudinary.com/dfr1kvie3/image/upload/v1702995309/coal_india_eucoix.png" alt="" />
            </motion.div>
            <motion.div initial={{ x: 20, y:-5 }}
            whileInView={{ x: 0, y:0 }} transition={{duration:0.8}} className='col-span-1 flex justify-center items-center bg-[url("")] backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
            <img className='rounded' src="https://res.cloudinary.com/dfr1kvie3/image/upload/v1702995309/skoda_p0wqmu.png" alt="" />
            </motion.div>
            <motion.div initial={{ x: 10, y:-5 }}
            whileInView={{ x: 0, y:0 }} transition={{duration:1}} className='col-span-1 flex justify-center items-center bg-[url("")] backdrop-blur-lg bg-opacity-60 rounded-lg p-5 bg-no-repeat bg-contain bg-center'>
